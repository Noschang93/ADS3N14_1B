...
{			 
    ...
    public AvlTree direita;
    public AvlTree esquerda;
 
    public AvlTree inserir(AvlTree aux, int num, Contador cont) 
    {
    	AvlTree novo;
    ...
    public AvlTree balanceamento(AvlTree aux, Contador cont) 
    {
        int d, df;
    ...
    public AvlTree rotacaoEsquerda(AvlTree aux) 
    {
    	AvlTree aux1, aux2;
        aux1 = aux.direita;
        aux2 = aux1.esquerda;
    ...
    public AvlTree rotacaoDireita(AvlTree aux) 
    {
    	AvlTree aux1, aux2;
        aux1 = aux.esquerda;
        aux2 = aux1.direita;
    ...
    public void infixa(AvlTree aux) 
    {
        if (aux != null) 
        {
        	infixa(aux.esquerda);
    ...
    public void prefixa(AvlTree aux) 
    {
        if (aux != null) 
        {
            System.out.print(aux.num + "\n");
    ...
    public void posfixa(AvlTree aux) 
    {
        if (aux != null) 
        {
    ...
    public AvlTree excluir(AvlTree aux, int num) 
    {
    	AvlTree p, p2;
        if (aux.num == num) 
        {
    ...
    public AvlTree atualizar(AvlTree aux, Contador cont) 
    {
        if (aux != null) 
        {
    ...
    public boolean consultar(AvlTree aux, int num, boolean loc, Contador cont) 
    {
